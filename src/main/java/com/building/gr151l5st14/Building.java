...
public class Building extends Union {
	...
	//верхняя полоска
		...
		Difference generalBuilding10 = new Difference(
				new Cube(new Dims3d(60, LENGTH-5, 3)).move(Coords3d.zOnly(75)).move(Coords3d.yOnly(7))
		);
                
                Difference colon = new Difference(
				new Cylinder(HEIGHT,RADIUS).move(Coords3d.yOnly(22))
		);
    
                models.add(colon.move(Coords3d.xOnly(75)));
		models.add(colon.move(Coords3d.xOnly(117.5)));
		models.add(colon.move(Coords3d.xOnly(55.5)));
		models.add(colon.move(Coords3d.xOnly(95)));
		models.add(colon.move(Coords3d.xOnly(35)));
		models.add(colon.move(Coords3d.xOnly(-75)));
		models.add(colon.move(Coords3d.xOnly(-117.5)));
		models.add(colon.move(Coords3d.xOnly(-55.5)));
		models.add(colon.move(Coords3d.xOnly(-95)));
